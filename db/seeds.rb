...
americano = Drink.create(name: "Americano", description: "A strong espresso drink with water", caffeine: true, milk: false, sweet: false)
iced_coffee = Drink.create (name: "Iced Coffee", description: "A strong coffee beverage that's very customizable", caffeine: true, milk: false)
